...
% Last Modified by GUIDE v2.5 25-May-2018 17:44:28
...
% hObject    handle to figure
% eventdata  reserved - to be defined in afuture version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
axes(handles.axes3);
patch(FV, 'FaceColor', 'interp','EdgeColor', 'none', 'FaceLighting', 'phong'); axis equal; axis off;
